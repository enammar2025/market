        ...
        <div class="col-md-3">
            <div class="card sidebar shadow-sm mb-4">
                ...
                <ul class="list-group list-group-flush" id="category-list">
                    <li class="list-group-item active d-flex justify-content-between align-items-center" data-cat-id="all">
                        الكل
                        <span class="badge bg-secondary rounded-pill"><?= htmlspecialchars($total_products) ?></span>
                    </li>
                    <?php foreach ($categories as $cat): ?>
                        <li class="list-group-item d-flex justify-content-between align-items-center" 
                            ...
                            <span class="badge bg-secondary rounded-pill">
                                <?= isset($cat['product_count']) ? htmlspecialchars($cat['product_count']) : 0 ?>
                            </span>
                        </li>
                    <?php endforeach; ?>
                </ul>
                ...
                <?php while ($row = $products_result->fetch(PDO::FETCH_ASSOC)): ?>
                    <div class="col-md-4 col-sm-6 product-item"
                        ...
                        <div class="card product-card h-100 shadow-sm">
                            <?php
                            // تحديد مسار الصورة
                            $imagePath = '/assets/images/products/default.jpg'; // صورة افتراضية
                ...
                <ul class="pagination justify-content-center">
                    <?php for ($i = 1; $i <= $total_pages; $i++): ?>
                        <li class="page-item <?= $i == $page ? 'active' : '' ?>">
                            <a class="page-link" href="?page=<?= $i ?>&<?= http_build_query(['category' => $category_id, 'search' => $search]) ?>">
                                <?= $i ?>
                            </a>
                        </li>
                    <?php endfor; ?>
